const LETTER_POOL = $('letter-pool'),
TEMP_LETTER_POOL = $('temp-letter-pool'),
LETTER_OVERLAY = $('letter-overlay'),
CHAT_MESSAGE_COLUMN_WRAPPER = $('chat-message-column-wrapper'),
CHAT_MESSAGE_COLUMN = $('chat-message-column'),
MESSAGE_INPUT = $('message-input'),
MESSAGE_INPUT_FIELD = $('message-input-field'),
CHAT_BOT_MOOD = $('chat-bot-mood'),
CHAT_BOT_MOOD_VALUE = $('chat-bot-mood-value');
